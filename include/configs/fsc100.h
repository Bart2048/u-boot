...
/*
 *##### select uart console configuration
 */
#define CONFIG_UART0			1	/* use uart*/
#define CONFIG_GET_CHAR         1
...
#define CONFIG_IDENT_STRING		" for FSC100"
